      ...
      <div className="border border-custom-grey rounded-t-3xl w-[200px]">
        <Link href={`/home/products/${product_id}`}>
          ...
          <div className="flex flex-row justify-between">
            <div className="px-2">
              <Rate disabled allowHalf defaultValue={averageRate} style={{fontSize: '.9rem'}} />
            </div>
            <div className="text-right text-xl font-bold px-2"><span className="text-sm">$</span>{price}</div>
          </div>
        </Link>
      </div>
    </div>
